...
Canonical immutable scan result -> normalized resonance parameters -> standing-wave field -> interference field -> convergence field -> contour and node extraction -> luminous SVG signature -> reproducibility manifest.
...
Each constellation starts as a field family, but production contours are extracted from one unified combined energy field. Debug panels may isolate component fields.
